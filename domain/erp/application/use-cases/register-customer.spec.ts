...
import { RegisterCustomerUseCase } from '@/domain/erp/application/use-cases/register-customer'
...
describe('Register Customer', () => {
  ...
  it('should not be able to register a new customer if there is no current user', async () => {
  ...
  it('should not be able to register a new customer from a non-admin account', async () => {
    fixture.customersRepo.create(
      makeCustomer({}, new UniqueEntityID('customer-1')),
    )
  ...
  it('should not be able to register a new customer if the email is already in use', async () => {
    fixture.adminsRepo.create(makeAdmin({}, new UniqueEntityID('admin-1')))
  ...
  it('should not be able to register a new customer if the password does not match the requirements', async () => {
    fixture.adminsRepo.create(makeAdmin({}, new UniqueEntityID('admin-1')))
